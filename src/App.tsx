    ...
    <div className="min-h-screen bg-system-bg text-slate-900 font-rajdhani overflow-x-hidden selection:bg-system-neon selection:text-white">
      ...
      <div className="fixed top-6 right-6 z-50">
        <button
          ...
          className="group px-6 py-2 bg-cyan-500/10 backdrop-blur-md border border-cyan-500/50 text-cyan-400 font-bold uppercase tracking-widest hover:bg-cyan-500 hover:text-slate-900 transition-all duration-300 rounded-full shadow-[0_0_15px_rgba(6,182,212,0.3)] hover:shadow-[0_0_25px_rgba(6,182,212,0.5)] text-sm md:text-base"
        >
          ARISE
        </button>
      </div>
